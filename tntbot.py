...
# TODO add attendance_status command
# TODO nice format for copy pasting into google sheet
# TODO gspread to automatically added data to google sheet
...
TNT_START = datetime.now(TZ).replace(hour=21, minute=0, tzinfo=TZ)
TNT_END   = datetime.now(TZ).replace(hour=22, minute=0, tzinfo=TZ)
